<?php
    ...
    class Rutina{
        ...
        public static function obtenerRutinas(){
            $objAccesoDatos = AccesoDatos::obtenerInstancia();
            $consulta = $objAccesoDatos->prepararConsulta("SELECT idRutina, nombre, descripcion, s.nombreSalon AS salon FROM rutina AS r, salon AS s WHERE r.salon = s.idSalon");
            $consulta->execute();
